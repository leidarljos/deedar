...
- [[file:howto.org][How-to]]: sign a satchel, audit a store, backfill a log, demand attestation.
- [[file:reference.org][Reference]]: kinds, verbs, the log, the store layout.
- [[file:explanation.org][Explanation]]: why signatures alone do not bind a set, and what the log adds.
